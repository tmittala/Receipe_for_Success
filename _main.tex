...
I enjoy traveling and visiting new places and believe in giving my 💯\% in whatever I do. In my free time, I like to cook, play video games, or read about new and interesting topics surrounding business and tech. Feel free to connect with me on LinkedIn(\url{https://www.linkedin.com/in/tmittala/})!
...
\addcontentsline{toc}{section}{Need for Hard Adoption}

\hypertarget{industry-overview}{%
\section*{Industry Overview}\label{industry-overview}}
\addcontentsline{toc}{section}{Industry Overview}

\hypertarget{finance}{%
\section*{Finance}\label{finance}}
\addcontentsline{toc}{section}{Finance}

\hypertarget{tech}{%
\section*{Tech}\label{tech}}
\addcontentsline{toc}{section}{Tech}

\hypertarget{retail}{%
\section*{Retail}\label{retail}}
\addcontentsline{toc}{section}{Retail}
...
\addcontentsline{toc}{section}{Public Sector - Department of Defense}
...
\addcontentsline{toc}{section}{Things to Consider}
...
(Impact, 2021)
\url{https://www.impactmybiz.com/blog/barriers-to-technology-adoption-in-business/}
