...
\item
  ...
  \tightlist
  \item
    \href{03-Soft-vs-Hard-Adoption.Rmd}{Soft vs Hard Adoption}
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    \href{04-Relevance-of-Hard-Adoption.Rmd}{Relevance of Hard Adoption}
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\hypertarget{soft-vs-hard-adoption}{%
\section*{Soft vs Hard Adoption}\label{soft-vs-hard-adoption}}
\addcontentsline{toc}{section}{Soft vs Hard Adoption}

\hypertarget{relevance-of-hard-adoption}{%
\section*{Relevance of Hard Adoption}\label{relevance-of-hard-adoption}}
\addcontentsline{toc}{section}{Relevance of Hard Adoption}
